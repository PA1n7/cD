...
if(mobile){
    ...
    timer.style.justifyContent = "justify"
    document.getElementById("title").style.fontSize = "2em"
    document.getElementsByTagName("hr")[0].style.width = "100%"
...
var loop = window.setInterval(()=>{
    ...
    if (!mobile){
        ...
        dateString = (sub.getMonth()+":"+sub.getDate()+"<br>"+sub.getHours()+":"+sub.getMinutes()+":"+sub.getSeconds());
    }
